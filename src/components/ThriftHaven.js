        ...
        <Grid item xs={8}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={4}>
              <ProductCard
                title="Shorts"
                picUrl="https://images.unsplash.com/photo-1591195853828-11db59a44f6b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8c2hvcnRzfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60"
                onAddToCart={() =>
            ...
            <Grid item xs={4}>
              <ProductCard
                title="Hoodie"
                picUrl="https://media.istockphoto.com/id/154960461/photo/red-sweat-shirt-on-white-background.webp?b=1&s=170667a&w=0&k=20&c=cPVGdWY52XQiBFKoCc-eWdjMJXKdzk_iiGGXCTSZo-U="
                onAddToCart={() =>
            ...
            <Grid item xs={4}>
              <ProductCard
                title="Shirt"
                picUrl="https://images.unsplash.com/photo-1598032895397-b9472444bf93?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8c2hpcnR8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60"
                onAddToCart={() =>
